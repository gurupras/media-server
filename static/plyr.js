...
var googleCast = {
    setup: function setup(config) {
        ...
        if (!utils.is.element(this.elements.googlecast)) {
            this.elements.googlecast = utils.createElement('div', utils.getAttributesFromSelector(this.config.selectors.googlecast));
        ...
        if (!window.chrome.cast) {
            utils.loadScript(this.config.urls.googleCast.api).then(function () {
                ...
                var interval = setInterval(function () {
                    if (window.chrome.cast.isAvailable) {
                        ...
                        var opts = utils.extend({}, googleCast.defaults, config);
    ...
    castStateListener: function castStateListener(data) {
        ...
        if (plyr && castEvent) {
            var castActive = castEvent === 'castenabled';
            // Add class hook
    ...
    show: function show() {
        ...
        // Try to load the value from storage
        var active = this.storage.googlecast;
